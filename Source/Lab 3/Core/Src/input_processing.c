...
int temp_duration = 0;
static int auto_increment_timer = 0;
    ...
    if (systemMode > 0) {
        switch(button1State) {
            ...
            case BUTTON_PRESSED:
                ...
                break;
            // Increase value every 500ms (0.5s) after holding button > 1s
